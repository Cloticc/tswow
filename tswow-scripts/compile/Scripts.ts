...
export namespace Scripts {
    export async function build() {
        ...
        makeTsConfig(
            ipaths.bin.scripts.wowdata.abs()
          , bpaths.scripts_config.wowdata.abs()
          , [spaths.tswow_scripts.wowdata.abs(), spaths.tswow_scripts.util.abs()]
        )
        ...
        spaths.tswow_scripts.wowdata.package_json
            .copy(ipaths.bin.scripts.wowdata.package_json)
    }
}
